...
#include "bos_getitem_device_operation.hpp"
...
void BosGetItemOperation::validate_inputs(
    ...
    TT_FATAL(
        ...
        "ttnn::operations::bos::bos_getitem temporarily supports only ROW_MAJOR layout.");
...
BosGetItemOperation::program_factory_t BosGetItemOperation::select_program_factory(
    const operation_attributes_t& operation_attributes, const tensor_args_t& tensor_args) {
    ...
    TT_FATAL(
        input_layout == Layout::ROW_MAJOR,
        "ttnn::operations::bos::bos_getitem temporarily supports only ROW_MAJOR layout.");
    return BosGetItemRmFactory();
}

void BosGetItemOperation::validate_on_program_cache_miss(
    const operation_attributes_t& operation_attributes, const tensor_args_t& tensor_args) {
    validate_inputs(operation_attributes, tensor_args);
};

void BosGetItemOperation::validate_on_program_cache_hit(
    const operation_attributes_t& operation_attributes, const tensor_args_t& tensor_args) {
    validate_inputs(operation_attributes, tensor_args);
};

BosGetItemOperation::spec_return_value_t BosGetItemOperation::compute_output_specs(
    const operation_attributes_t& operation_attributes, const tensor_args_t& tensor_args) {
...
BosGetItemOperation::tensor_return_value_t BosGetItemOperation::create_output_tensors(
    const operation_attributes_t& operation_attributes, const tensor_args_t& tensor_args) {
    if (tensor_args.output.has_value()) {
...
std::tuple<BosGetItemOperation::operation_attributes_t, BosGetItemOperation::tensor_args_t>
BosGetItemOperation::invoke(
    const Tensor& input,
