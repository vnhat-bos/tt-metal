...
BosGetItemOperation::BosGetItemRmFactory::cached_program_t BosGetItemOperation::BosGetItemRmFactory::create(
    ...
    auto reader_kernel_id = CreateReadKernel(
        program,
        "ttnn/cpp/ttnn/operations/bos/bos_getitem/device/bos_getitem_kernels/reader_bos_getitem.cpp",
        all_cores,
        {
            src_is_dram,
    ...
    auto writer_kernel_id = CreateWriteKernel(
        program,
        "ttnn/cpp/ttnn/operations/bos/bos_getitem/device/bos_getitem_kernels/writer_bos_getitem.cpp",
        all_cores,
        {dst_is_dram},
        writer_defines);
...
void BosGetItemOperation::BosGetItemRmFactory::override_runtime_arguments(
