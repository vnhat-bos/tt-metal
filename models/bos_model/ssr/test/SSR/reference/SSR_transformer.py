...
from test.SSR.reference.spatial_cross_attention import MSDeformableAttention3D
...
class MapDetectionTransformerDecoder(TransformerLayerSequence): # TODO: Remove this block
...
class SSRPerceptionTransformer(BaseModule):
    ...
    def get_bev_features(
        ...
        # NOTE Save bev_pos and bev_queries for pre-loading in ttnn model
