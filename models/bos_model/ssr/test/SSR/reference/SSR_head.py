...
from test.SSR.reference.tokenlearner import *
from test.SSR.reference.bbox_coder import fut_nms_free_coder, map_nms_free_coder, nms_free_coder
...
class SSRHead(nn.Module):
    ...
    def _init_layers(self):
        ...
        self.tokenlearner = TokenLearnerV11_Torch(self.num_scenes, self.embed_dims * 2)
