...
class FPN(BaseModule):
    ...
    def __init__(
        ...
        for i in range(self.start_level, self.backbone_end_level):
            l_conv = FPNConvModule(in_channels[i], out_channels, 1, bias=True, act="", cfg=conv_cfg)
            fpn_conv = FPNConvModule(out_channels, out_channels, 3, padding=1, bias=True, act="", cfg=conv_cfg)
        ...
        if self.add_extra_convs and extra_levels >= 1:
            for i in range(extra_levels):
                ...
                extra_fpn_conv = FPNConvModule(
                    in_channels, out_channels, 3, bias=True, stride=2, padding=1, act="", cfg=conv_cfg
                )
