...
# from tt.projects.mmdet3d_plugin.datasets.pipelines import DefaultFormatBundle3D
_registry = getattr(PIPELINES, 'module_dict', getattr(PIPELINES, '_module_dict', {}))
_registry.pop('DefaultFormatBundle', None)
