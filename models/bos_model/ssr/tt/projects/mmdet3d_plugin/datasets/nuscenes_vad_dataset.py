...
import random
from tt.projects.mmdet3d_plugin.core.bbox.structures import LiDARInstance3DBoxes
from nuscenes.utils.data_classes import Box as NuScenesBox
from tt.projects.mmdet3d_plugin.core.bbox.structures.nuscenes_box import CustomNuscenesBox
...
@DATASETS.register_module(name="VADCustomNuScenesDataset")
class VADCustomNuScenesDataset(NuScenesDataset):
    ...
    def _format_gt(self):
        gt_annos = []
        logger.debug('Start to convert gt map format...')
    ...
    def _format_bbox(self, results, jsonfile_prefix=None, score_thresh=0.2, is_ttnn=False):
        ...
        for sample_id, det in enumerate(mmcv.track_iter_progress(results)):
            ...
            plan_gts[sample_token] = [self.data_infos[sample_id]['gt_ego_fut_trajs'], self.data_infos[sample_id]['gt_ego_fut_cmd']]
    ...
    def _format_bbox_realtime(self, results, is_ttnn=False, sample_idx=0):
        ...
        plan_gts[sample_token] = [self.data_infos[sample_idx]['gt_ego_fut_trajs'], self.data_infos[sample_idx]['gt_ego_fut_cmd']]
    ...
    def _evaluate_single(self,
        ...
        from tt.projects.mmdet3d_plugin.datasets.map_utils.mean_ap import eval_map
        from tt.projects.mmdet3d_plugin.datasets.map_utils.mean_ap import format_res_gt_by_classes
