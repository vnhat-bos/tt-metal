...
from tt.projects.mmdet3d_plugin.core.bbox.structures.utils import limit_period, xywhr2xyxyr, boxes_overlap_bev
...
class BaseInstance3DBoxes(object):
    ...
    def overlaps(cls, boxes1, boxes2, mode='iou'):
        ...
        boxes_overlap_bev(boxes1_bev.contiguous(),
                                         boxes2_bev.contiguous(),
                                         overlaps_bev)
