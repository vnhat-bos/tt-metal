...
from tt.projects.mmdet3d_plugin.core.points.base_points import BasePoints
from tt.projects.mmdet3d_plugin.core.bbox.structures.base_box3d import BaseInstance3DBoxes
...
from tt.projects.mmdet3d_plugin.core.bbox.structures.utils import limit_period, rotation_3d_in_axis, points_in_boxes_cpu
...
class CustomLiDARInstance3DBoxes(BaseInstance3DBoxes):
    ...
    def points_in_boxes(self, points):    # WARNING: points_in_boxes_gpu is not supported
